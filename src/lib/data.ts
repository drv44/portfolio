...
export const skills: Skill[] = [
  ...
  { name: "Express.js", icon: ServerCog, level: 3 },
  { name: "Flask", icon: FileCode, level: 3 },
  { name: "Prisma", icon: Database, level: 2 },
  { name: "Supabase", icon: Database, level: 2 },
  { name: "Shadcn", icon: Wind, level: 2 },
  { name: "Gemini API", icon: Lightbulb, level: 2 },
  { name: "VS Code", icon: FileCode, level: 3 },
  { name: "Postman", icon: Briefcase, level: 2 },
  { name: "Optimization", icon: Lightbulb, level: 2 },
  { name: "Analytics", icon: Atom, level: 2 },
  { name: "Redux", icon: FileCode, level: 3 },
  { name: "Jest", icon: Lightbulb, level: 2 },
  { name: "Chakra UI", icon: Wind, level: 2 },
  { name: "Material UI", icon: Wind, level: 2 },
  { name: "GraphQL", icon: Lightbulb, level: 2 },
  { name: "Sass", icon: Code2, level: 2 },
  { name: "Figma", icon: FileCode, level: 2 },
  { name: "Vercel", icon: ServerCog, level: 2 },
  { name: "Netlify", icon: ServerCog, level: 2 },
  { name: "Jupyter", icon: FileCode, level: 2 },
  { name: "Pandas", icon: Atom, level: 2 },
  { name: "NumPy", icon: Atom, level: 2 },
  { name: "Matplotlib", icon: Lightbulb, level: 2 },
  { name: "Linux", icon: ServerCog, level: 2 },
  { name: "Bash", icon: FileCode, level: 2 },
  { name: "Firebase", icon: Database, level: 2 },
  { name: "AWS", icon: ServerCog, level: 2 },
  { name: "GCP", icon: ServerCog, level: 2 },
  { name: "DBMS", icon: Database, level: 3 },
  { name: "Data Structures", icon: Layers, level: 3 },
  { name: "OOP", icon: Atom, level: 3 },
  { name: "Operating Systems", icon: ServerCog, level: 3 },
]
